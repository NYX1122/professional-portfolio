            ...
            <h2>About Me</h2>
                <div className='about-row-one'>
                    ...
                    <div className='about-para'>
                        <h3>Background</h3>
                        <p>
                            <span class={'indent'}></span>To begin I’d just like to say thanks for viewing my portfolio page, I hope you like it :) . I’m a twenty
                            ...
                            <br/>
                            <br/>
                            <span class={'indent'}></span>I grew up on a farm in eastern Utah, and attended Uintah High School at the nearby town of Vernal. As
                            ...
                            <br/>
                            <br/>
                            <span class={'indent'}></span>And what a journey it’s been! I moved across Utah to the Salt Lake Valley, leaving the place I grew up 
                ...
                <div className='about-row-two'>
                    <div className='about-para'>
                        ...
                        <p><span class={'indent'}></span>
                            ...
                            <br/>
                            <br/>
                            <span class={'indent'}></span>Along with these Web Development skills I also have high typing speed (69 WPM based on the medium text
